                        ...
                        <tr>
                            ...
                            <td style="width: 250px;">
                                ...
                                @if($agent->status_id==1)
                                    <a href="#" class="btn btn-danger disable-agent" data-id="{{$agent->agent_code}}" id="{{$agent->agent_code}}" ><i class="fa fa-trash"></i></a>

                                @elseif($agent->status_id==0)
                                    <a href="#" class="btn btn-cyan enable-agent" data-id="{{$agent->agent_code}}" id="{{$agent->agent_code}}" ><i class="fa fa-toggle-on"></i></a>
...
@section('js')
    ...
    <script>
        ...
        $(document).on('click', '.enable-agent', function() {
            let Id  =  $(this).data('id');

...
<div class="modal fade bd-example-modal-lg" id="show-topup-agent-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <form method="post" action="{{url('/aggregators/store-topup')}}" id="form-topup-agent"  enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" readonly  value="{{$code}}" name="agent_code" id="agent_code">

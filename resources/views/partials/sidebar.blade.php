    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <ul id="sidebarnav" class="p-t-30">
                ...
                @endcan
                @cannot('view-action-menu')
                    <li class="sidebar-item"><a class="sidebar-link has-arrow waves-effect waves-dark"
                                                href="javascript:void(0)" aria-expanded="false">
                            <i class="mdi mdi-bookmark"></i><span class="hide-menu">Actions</span></a>
                        <ul aria-expanded="false" class="collapse  first-level">
                            <li class="sidebar-item"><a href="{{ url('applications/PA') }}" class="sidebar-link">
                                    <i class="mdi mdi-note-outline"></i><span class="hide-menu">Pending
                                        Approvals</span></a>
                            </li>
                        </ul>
                ...
                @can('manage-wallet')
                    <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false">
                        ...
                        <ul aria-expanded="false" class="collapse  first-level">
                            ...
                            <li class="sidebar-item"><a href="{{url('wallet/destroy-account')}}" class="sidebar-link"><i class="mdi mdi-note-outline">

                                    </i><span class="hide-menu">Ncard Destroy account</span></a>
                            </li>

                            <li class="sidebar-item"><a href="{{url('cards-info')}}" class="sidebar-link"><i class="mdi mdi-note-outline">

                                    </i><span class="hide-menu">Card upload info</span></a>
                            </li>
...
{{--                            @can('customer-refund')--}}
{{--                                <li class="sidebar-item"><a href="{{url('refund/top')}}" class="sidebar-link"><i class="mdi mdi-note-outline">--}}
...
{{--                            @endcan--}}
                ...
                <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                    ...
                    <ul aria-expanded="false" class="collapse  first-level">
                        ...
                        <li class="sidebar-item"><a href="{{url('adjustment')}}" class="sidebar-link"><i class="mdi mdi-note-outline">

                                </i><span class="hide-menu">Adjustment</span></a>
                        </li>
                    </ul>
                </li>
                ...
                @can('view-report')
                    <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-book"></i><span class="hide-menu">Reports</span></a>
                        <ul aria-expanded="false" class="collapse  first-level">
                            {{--                            @can('agent-topup')--}}
                            <li class="sidebar-item"><a href="{{url('reconciliation')}}" class="sidebar-link"><i class="fa fa-cog"></i><span class="hide-menu">Reconciliation</span></a></li>

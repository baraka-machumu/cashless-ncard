...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="<?php echo e(asset('public/assets/images/ncard.ico')); ?>">

    <link rel="shortcut icon" type="image/x-icon"  href="<?php echo e(asset('public/assets/images/ncard.ico')); ?>">

    <!-- Custom CSS -->
    <link href="<?php echo e(asset('public/assets/css/select2.min.css')); ?>" rel="stylesheet">

    <link href="<?php echo e(asset('public/assets/css/datatables.css')); ?>" rel="stylesheet">
    ...
    <link href="<?php echo e(asset('public/assets/css/typeahead.min.css')); ?>" rel="stylesheet">
...
<!--Custom JavaScript -->
<script src="<?php echo e(asset('public/assets/js/typeahead.min.js')); ?>"></script>

<script src="<?php echo e(asset('public/assets/js/custom.min.js')); ?>"></script>

<script src="<?php echo e(asset('public/assets/js/select2.full.min.js')); ?>"></script>
...
<script src="<?php echo e(asset('public/assets/js/customization.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/js/second_customization_file.js')); ?>"></script>

<script src="<?php echo e(asset('public/assets/js/merchant_users.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/js/agents.js')); ?>"></script>
<script src="//cdnjs.cloudflare.com/ajax/libs/numeral.js/1.4.5/numeral.min.js"></script>
<script src="<?php echo e(asset('public/assets/js/validatorForm.min.js')); ?>"></script>

<script src="<?php echo e(asset('public/assets/js/consumer-live-data.js')); ?>"></script>
...
<script type="text/javascript">
    ...
    let district_url  =  '<?php echo e(url('districts/get-all')); ?>';


    let  agentGetAllPos=   '<?php echo e(url('agents/getall/pos')); ?>';
...
<?php /**PATH C:\xampp\htdocs\cashless\resources\views/layouts/master.blade.php ENDPATH**/ ?>
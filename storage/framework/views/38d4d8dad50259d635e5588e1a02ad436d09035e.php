...
<div class="modal fade bd-example-modal-sm" id="cash-out-modal" role="dialog" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-dialog modal-md" role="document" >
        <div class="modal-content">
            ...
            <form method="post" action="<?php echo e(url('Fund/transfer-to-merchant')); ?>">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input type="hidden" name="tin" value="<?php echo e($tin); ?>">
...
<?php /**PATH C:\xampp\htdocs\cashless\resources\views/cash_out/cash_out_modal.blade.php ENDPATH**/ ?>
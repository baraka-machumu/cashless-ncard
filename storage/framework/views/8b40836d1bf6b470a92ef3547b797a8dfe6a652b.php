...
<div class="modal fade bd-example-modal-lg" id="show-card-disable-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <form method="post" action="<?php echo e(url('wallet/disabled-consumer-card')); ?>">
...
<?php /**PATH C:\xampp\htdocs\cashless\resources\views/wallets/actions/disable_card_modal.blade.php ENDPATH**/ ?>